...
namespace SariRotiIndiAll_Parsing
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fileStream = new FileStream(@"D:\spssparsing\SRINDI\All\SR-Indi-s16-All-Sep-18.sav", FileMode.Open, FileAccess.Read, FileShare.Read, 2048 * 10, FileOptions.SequentialScan))
            {
                ...
                foreach (var record in spssDataset.Records)
                {
                    ...
                    string B32_1= "-- Not Available --";
                    string B32_2= "-- Not Available --";
                    string B32_3= "-- Not Available --";
                    string B32_4= "-- Not Available --";
                    string B33b_1= "-- Not Available --";
                    string B33b_2= "-- Not Available --";
                    string B33b_3= "-- Not Available --";
                    string B33b_4= "-- Not Available --";
                    string B34_1= "-- Not Available --";
                    string B34_2= "-- Not Available --";
                    string B35a_1= "-- Not Available --";
                    string B35a_2= "-- Not Available --";
                        ...
                        foreach (string spss_v in spss_variable_name)
                        {
                            if (variable.Name.Equals(spss_v))
                            {
                                ...
                                switch (variable_name)
                                {
                                    ...
                                    case "B30": { Slogan_Aware = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B31": { Slogan_Correct_brand = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B32_1": { B32_1 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B32_2": { B32_2 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B32_3": { B32_3 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B32_4": { B32_4 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B33b_1": { B33b_1 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B33b_2": { B33b_2 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B33b_3": { B33b_3 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B33b_4": { B33b_4 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B34_1": { B34_1 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B34_2": { B34_2 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B35a_1": { B35a_1 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "B35a_2": { B35a_2 = Convert.ToString(record.GetValue(variable)); break; }
